...
//        Scale9Sprite* bg = Scale9Sprite::create("dialog/dialog_bg.png", rect,rect_inside);
		m_pBg = Sprite::create("images/dialog/popup_bg.png");
//		bg->setPreferredSize(Size(599, 380));
        ...
        title_label = Label::createWithBMFont(font_felt.c_str(), "");//("", font_felt.c_str(), 40);
		...
		content_label = Label::createWithBMFont(font_felt.c_str(),"");
		content_label->setDimensions(dialogSize.width*0.65, dialogSize.height*0.4);
        
        
		content_label->setAnchorPoint(Point(0.5,0.5));
        content_label->setPosition(Vec2(m_pBg->getContentSize().width/2, m_pBg->getContentSize().height/2-30));
//		content_label->setColor(Color3B(0,0,128));
        ...
        positive->setPosition(Vec2(2*m_pBg->getContentSize().width/3 + 30,5));
        
        positive_label = Label::createWithBMFont(font_felt.c_str(),"");
        ...
        negative_label = Label::createWithBMFont(font_felt.c_str(),"");
		...
		mMenu->setPosition(Point(dialogSize.width/2 + 30,dialogSize.height*0.05 + 20 + 20));

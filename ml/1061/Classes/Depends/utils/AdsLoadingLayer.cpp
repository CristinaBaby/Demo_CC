...
bool AdsLoadingLayer::m_bIsFrom = false;
...
//        cocostudio::Armature *armature = cocostudio::Armature::create("loading3");
//        
//        kAdapterScreen->setExactPosition(armature, 320, 280);
...
//        armature->getAnimation()->play("Animation1");
        ...
        ChangeLoading* change = ChangeLoading::create();

...
//            }
//                break;
            case GameUIEvent::eSceneTagBurgerDisplay:{
                SceneManager::pushTheScene<BurgerDisplayIngredientScene>();
            }
                break;
            case GameUIEvent::eSceneTagHotdogDisplay:{
                SceneManager::pushTheScene<HotdogDisplayIngredientScene>();
            }
                break;

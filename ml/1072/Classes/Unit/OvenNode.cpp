...
bool OvenNode::init()
{
    ...
    m_pBody = Sprite::create("content/make/common/bake/oven0.png");
...
//    时间开关
    {
        m_pTimeNode = Sprite::create("content/make/common/bake/k_time8.png");
...
void OvenNode::openDoor()
{
    ...
    m_pBodyDoor->runAction(Sequence::create(RotateBy::create(1, Vec3(80, 0, 0)),
                                            CallFunc::create([=]()
                                                             {
...
//    m_pTempMask->runAction(RotateBy::create(8, 180));
    m_pTimePoint->runAction(Sequence::create(RotateBy::create(15, -180),
                                             CallFunc::create([=](){
        stopBake();
    }), NULL));
}
...
void OvenNode::stopBake()
{
    ...
    this->stopAllActions();
    m_pBody->setTexture("content/make/common/bake/oven0.png");
    m_bBaked = true;
    m_bIsBaking = false;
    if (onBakeCallback) {
...
void OvenNode::_showControlFrame()
{
    ...
    Sprite* pGuideTemp = Sprite::create("content/common/tip/arrow1.png");
    ...
    Sprite* pGuideTime = Sprite::create("content/common/tip/arrow1.png");

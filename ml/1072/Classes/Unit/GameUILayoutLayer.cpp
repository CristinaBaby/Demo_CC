...
void GameUILayoutLayer::showResetLayout(bool animate,bool up)
{
    ...
    if (!animate) {
        CMVisibleRect::setPosition(m_pReset, 10, 90+(up?0:100),kBorderRight,up?kBorderTop:kBorderBottom);
    }else{
        CMVisibleRect::setPosition(m_pReset, 10, 90+(up?0:100),kBorderRight,up?kBorderTop:kBorderBottom);
...
void GameUILayoutLayer::showShareUILayout(bool animate)
{
    ...
    CMVisibleRect::setPosition(m_pPhoto, 10, 30,kBorderRight,kBorderTop);
    //    CMVisibleRect::setPosition(m_pEmail, 10, 80,kBorderRight,kBorderTop);
    CMVisibleRect::setPosition(m_pHome, 10, 30,kBorderLeft,kBorderTop);

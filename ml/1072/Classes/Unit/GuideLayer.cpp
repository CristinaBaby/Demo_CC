...
void GuideLayer::showGuideMove(Vec2 begin,Vec2 end,float delayTime)
{
    ...
    m_pGuide->setAnchorPoint(Vec2(0.1, 0.96));
...
void GuideLayer::showGuideTap(Vec2 position,float delayTime)
{
    ...
    m_pGuide->setVisible(true);
    m_pGuide->setAnchorPoint(Vec2(0.1, 0.9));
    
    Sprite* pSprite = Sprite::create("content/common/tip/kick.png");
    this->addChild(pSprite,-1);
    pSprite->setName("kick");
    pSprite->setPosition(m_pGuide->getPosition());
    
    pSprite->runAction(RepeatForever::create(Sequence::create(DelayTime::create(delayTime),
...
void GuideLayer::showGuideArrow(Vec2 position,int direction,float delayTime)
{
    ...
    if (abs(direction)==1) {
        if (direction<0) {
            m_pGuide = Sprite::create("content/common/tip/arrows_1.png");
        }else{
            m_pGuide = Sprite::create("content/common/tip/arrows0.png");
        }

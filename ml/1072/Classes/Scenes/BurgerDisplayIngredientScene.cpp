...
#include "BurgerDisplayIngredientScene.h"
...
BurgerDisplayIngredientScene::BurgerDisplayIngredientScene()
{
...
bool BurgerDisplayIngredientScene::init()
{
    ...
    this->runAction(Sequence::create(DelayTime::create(1),
        ...
        Node* pCocosLayer = CSLoader::createNode("BurgerDisplayLayer.csb");
    ...
    m_nNextSceneTag = GameUIEvent::eSceneTagBurgerAddIngredient;
...
void BurgerDisplayIngredientScene::onEnter()
{
    ExtensionScene::onEnter();
    Analytics::getInstance()->sendScreenEvent(Flurry_EVENT_MAKE_BURGER);
}

#pragma mark - initData
void BurgerDisplayIngredientScene::_initData()
{
    setExPath("content/make/burger/0/");
}
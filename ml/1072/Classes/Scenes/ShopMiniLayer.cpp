...
bool ShopMiniLayer::init(bool dec)
{
    ...
    //    bg
    Sprite* pBg = Sprite::create(localPath("mini/minishop.png"));
    CMVisibleRect::setPosition(pBg, pShopMiniLayer->getChildByName("minishop")->getPosition());
    pRootNode->addChild(pBg);
    
    
    Button* pBackBtn = Button::create(localPath("close.png"));
    ...
    CMVisibleRect::setPosition(pBackBtn, pShopMiniLayer->getChildByName("close")->getPosition());
    
    Button* pRestoreBtn = Button::create(localPath("mini/shop_button.png"));
    ...
    CMVisibleRect::setPosition(pRestoreBtn, pShopMiniLayer->getChildByName("shop_button")->getPosition());
    
    Button* pRewardBtn = Button::create(localPath("mini/get_free.png"));
    ...
    pRootNode->addChild(pRewardBtn);
    CMVisibleRect::setPosition(pRewardBtn, pShopMiniLayer->getChildByName("get_free")->getPosition());

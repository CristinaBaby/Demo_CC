...
public:
    ...
    static void URLmark(const char* str);
    virtual void endSession();
    
private:
    static bool addSkipBackupAttributeToItemAtURL(const char* str);
    static bool addSkipBackupAttributeToItemAtURL501(const char* str);

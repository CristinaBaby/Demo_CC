...
{
    if (small == true) {
        linefile = "decoration/controlTip_bg_small.png";
        transportfile = "decoration/controlTip_bg_Clear_small.png";
        ItemSpace = 127;
    }else {
        linefile = "decoration/controlTip_bg.png";
        transportfile = "decoration/controlTip_bg_Clear.png";
        ItemSpace = 254;
    }
...
//    _close = CocosHelper3::getButton("ui/decorate/controlTip_close.png","ui/decorate/controlTip_close.png");
    ...
    Scale9Sprite* sp = Scale9Sprite::create("decoration/controlTip_close.png");
    _close = ControlButton::create(sp);
    _close -> setPreferredSize(Size(38,38));
    ...
    _magnify = Sprite::create("decoration/controlTip_magnify.png");

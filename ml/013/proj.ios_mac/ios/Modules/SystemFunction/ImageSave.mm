...
- (void)saveImage : (char *)pImagePath withTarget:(Ref*) target withCallFun : (CallFunction)callFun;{
   ...
   //      [[[error2 userInfo] objectForKey:@"NSLocalizedDescription" ] UTF8String]
         if (error2) {
             ...
             (target->*callFun)((void*) false,(void*)[[[error2 userInfo] objectForKey:@"NSLocalizedDescription" ] UTF8String]);
         }
         else {
             NSLog(@"PHOTO SAVED - assetURL: %@", assetURL);
             (target->*callFun)((void*) true,(void*)[[[error2 userInfo] objectForKey:@"NSLocalizedDescription" ] UTF8String]);
         }

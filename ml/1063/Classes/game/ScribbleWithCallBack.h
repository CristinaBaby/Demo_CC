...
#ifndef __ScribbleWithCallBack__
#define __ScribbleWithCallBack__

#include <stdio.h>
#include "ScribbleNode.h"

class ScribbleWithCallBack : public ScribbleNode {
public:
    ...
    static ScribbleWithCallBack *create(Size pCanvasSize);
...
public:
    std::function<void(cocos2d::Touch *,ScribbleWithCallBack::TouchType)> callBack;
};

#endif /* defined(__ScribbleWithCallBack__) */

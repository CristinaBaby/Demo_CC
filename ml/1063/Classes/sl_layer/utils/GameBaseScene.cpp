...
void GameBaseScene::initUI()
{
    ...
    m_pNextButton = ui::Button::create(g_path_ui + "public_btn_next.png");
    ...
    kAdapterScreen->setExactPosition(m_pNextButton, 10, 110 + m_pNextButton->getContentSize().height ,Vec2(0.5, 0.5),kBorderRight,kBorderBottom);
    m_pUILayer->addChild(m_pNextButton,100);
   
    m_pNextButton->setPosition(m_pNextButton->getPosition()-m_pNextButton->getContentSize()/2);
}

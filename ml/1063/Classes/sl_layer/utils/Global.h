...
"cocostudio/png/cake/dialog/HELVETICA_ROUNDED_LT_BLACK.TTF";
#else
"cocostudio/png/cake/dialog/HELVETICA_ROUNDED_LT_BLACK.TTF";
#endif
...
extern bool g_from_eat;

//图片的路径  方便修改
extern std::string g_path_dec;
extern std::string g_path_ui;

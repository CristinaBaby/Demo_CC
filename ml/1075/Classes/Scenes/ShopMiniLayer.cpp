...
bool ShopMiniLayer::init(bool dec)
{
    ...
    //    bg
    Sprite* pBg = Sprite::create(localPath("mini/mini_frame2.png"));
    CMVisibleRect::setPosition(pBg, pShopMiniLayer->getChildByName("mini_frame2")->getPosition());
    ...
    Button* pRestoreBtn = Button::create(localPath("mini/mini_shop.png"));
    ...
    CMVisibleRect::setPosition(pRestoreBtn, pShopMiniLayer->getChildByName("mini_shop")->getPosition());

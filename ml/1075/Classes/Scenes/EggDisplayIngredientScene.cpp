...
#include "EggDisplayIngredientScene.h"
...
EggDisplayIngredientScene::EggDisplayIngredientScene()
{
...
bool EggDisplayIngredientScene::init()
{
    ...
    this->runAction(Sequence::create(DelayTime::create(1),
                                     CallFunc::create([=](){
        Sprite* pFood =Sprite::create(localPath("food_1.png"));
        ...
        pItem->runAction(Sequence::create(DelayTime::create(1+0.8*i),
            ...
            if (i==total-1) {
                ...
                AudioHelp::getInstance()->playEffect("magic_effect.mp3");
                                          ...
                                          CallFunc::create([=](){
            if (i==total-1) {
                SceneManager::replaceTheScene<EggChooseModelScene>();
            }
        }), NULL));
    }
    return true;
...
void EggDisplayIngredientScene::onEnter()
{
    ExtensionScene::onEnter();
    Analytics::getInstance()->sendScreenEvent(Flurry_EVENT_MAKE_EGG);
}

void EggDisplayIngredientScene::onShopItemBuy(cocos2d::Ref *pRef)
{
}

void EggDisplayIngredientScene::dragNodeTouchBegin(DragNode* pDragNode,Point worldPoint)
{
}

void EggDisplayIngredientScene::dragNodeTouchMoved(DragNode* pDragNode,Point worldPoint)
{
}

void EggDisplayIngredientScene::dragNodeTouchEnded(DragNode* pDragNode,Point worldPoint){
    
}

void EggDisplayIngredientScene::dragNodeClicked(DragNode* pDragNode,Point worldPoint)
{
    
}

#pragma mark - initData
void EggDisplayIngredientScene::_initData()
{

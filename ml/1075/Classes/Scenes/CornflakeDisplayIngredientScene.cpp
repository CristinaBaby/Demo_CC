...
#include "CornflakeDisplayIngredientScene.h"
#include "SceneManager.h"

static std::string gsIngredients[] {
    "milk.png","sugar.png",
    "wtaer.png","corn meal.png"
};
CornflakeDisplayIngredientScene::CornflakeDisplayIngredientScene()
{
...
bool CornflakeDisplayIngredientScene::init()
{
    ...
    this->runAction(Sequence::create(DelayTime::create(1),
                                     CallFunc::create([=](){
        Sprite* pFood =Sprite::create(localPath("food_3.png"));
        ...
        pItem->runAction(Sequence::create(DelayTime::create(1+0.8*i),
            ...
            if (i==total-1) {
                ...
                AudioHelp::getInstance()->playEffect("magic_effect.mp3");
                                          ...
                                          CallFunc::create([=](){
            if (i==total-1) {
                SceneManager::replaceTheScene<CornflakeCookScene>();
            }
        }), NULL));
    }
    return true;
...
void CornflakeDisplayIngredientScene::onEnter()
{
    ExtensionScene::onEnter();
    Analytics::getInstance()->sendScreenEvent(Flurry_EVENT_MAKE_CORN);
}

void CornflakeDisplayIngredientScene::onShopItemBuy(cocos2d::Ref *pRef)
{
}

void CornflakeDisplayIngredientScene::dragNodeTouchBegin(DragNode* pDragNode,Point worldPoint)
{
}

void CornflakeDisplayIngredientScene::dragNodeTouchMoved(DragNode* pDragNode,Point worldPoint)
{
}

void CornflakeDisplayIngredientScene::dragNodeTouchEnded(DragNode* pDragNode,Point worldPoint){
    
}

void CornflakeDisplayIngredientScene::dragNodeClicked(DragNode* pDragNode,Point worldPoint)
{
    
}

#pragma mark - initData
void CornflakeDisplayIngredientScene::_initData()
{

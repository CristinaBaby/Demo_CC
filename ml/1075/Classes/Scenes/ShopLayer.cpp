...
bool ShopLayer::init()
{
    ...
    //    bg
    Sprite* pBg = Sprite::create(localPath("store_frame2.png"));
    CMVisibleRect::setPosition(pBg, pShopLayer->getChildByName("store_frame2")->getPosition());
    pRootNode->addChild(pBg,-2);
    
    Sprite* pBg2 = Sprite::create(localPath("store_frame1.png"));
    CMVisibleRect::setPosition(pBg2, pShopLayer->getChildByName("store_frame1")->getPosition());

...
bool BlenderNode::init(int type)
{
    ...
    m_pBody = Sprite::create("content/make/common/blender/mixer"+std::to_string(type)+".png");
    ...
    m_pCup->onFinishCrushIce = [=](){
        ...
        if (m_nType==1) {
            m_bReadyWork = true;
            m_pSwitch->loadTextures("content/make/common/blender/blender2_on.png", "content/make/common/blender/blender2_off.png","content/make/common/blender/blender2_off.png");
    ...
    if (type==0) {
        m_pHandle = Sprite::create("content/make/common/blender/blender1_1.png");
        ...
        m_pSwitch = Button::create("content/make/common/blender/blender2_off.png","content/make/common/blender/blender2_off.png","content/make/common/blender/blender2_on.png");
...
void BlenderNode::onButtonCallback(Ref* ref,Widget::TouchEventType type)
{
    ...
    if(type==Widget::TouchEventType::ENDED){
        if (!m_bFinishCrush) {
            ...
            AudioHelp::getInstance()->playLoopEffect("blender_running.mp3");
            m_pSwitch->setTouchEnabled(false);

...
//            bg->setAnchorPoint(Vec2(0.5,0.5));
            ...
            content_label = Label::createWithTTF("",font_felt.c_str(), fontsize(40),Size(dialogSize.width*0.7,dialogSize.height*0.8),TextHAlignment::CENTER, TextVAlignment::CENTER);

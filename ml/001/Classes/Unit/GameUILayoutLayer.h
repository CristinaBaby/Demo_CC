...
public:
    ...
    void showNextLayout(bool animate = true,bool up = false);
    void showBackLayout(bool animate = true,bool up = false);
    void showResetLayout(bool animate = true,bool up = false);

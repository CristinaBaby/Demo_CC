...
void GameUILayoutLayer::showHomeUILayout(bool animate)
{
    ...
    //    }
    if (!m_pHomeShop) {
        m_pHomeShop = _createButton("content/start/shop.png");
        this->addChild(m_pHomeShop);
    }
    if (!m_pHomeStart) {
        m_pHomeStart = _createButton("content/start/btn_start2.png");
        this->addChild(m_pHomeStart);
    }
    if (!m_pHomeRate) {
        m_pHomeRate = _createButton("content/common/button/btn_rate.png");
        this->addChild(m_pHomeRate);
    }
    if (!m_pHomePolicy) {
        m_pHomePolicy = _createButton("content/common/button/btn_pp.png");
    ...
    if (!animate) {
        ...
        CMVisibleRect::setPosition(m_pHomePolicy, 15, 15,kBorderRight,kBorderTop);
        CMVisibleRect::setPosition(m_pHomeRate, 15, 15,kBorderLeft,kBorderTop);
        ...
        CMVisibleRect::setPositionAdapted(m_pHomeStart, 320, 330);
...
void GameUILayoutLayer::showResetLayout(bool animate,bool up)
{
    ...
    if (!animate) {
        CMVisibleRect::setPosition(m_pReset, 10, 110+(up?0:100),kBorderRight,up?kBorderTop:kBorderBottom);
    }else{
        CMVisibleRect::setPosition(m_pReset, 10, 110+(up?0:100),kBorderRight,up?kBorderTop:kBorderBottom);
...
//    CMVisibleRect::setPosition(m_pEmail, 10, 110,kBorderRight,kBorderTop);

...
public:
    ProgressBar();
    static ProgressBar* create(std::string barPath,std::string beginPath,std::string okPath,std::string badPath,Direction dir = Direction::eDirectionH);
    bool init(std::string barPath,std::string beginPath,std::string okPath,std::string badPath,Direction dir = Direction::eDirectionH);

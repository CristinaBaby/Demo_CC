...
//    m_pShadow = Sprite::create("content/make/flavor/cup_shadow.png");
//    this->addChild(m_pShadow);
    
    m_pBottleBack = Sprite::create("content/make/flavor/cup_down.png");
    this->addChild(m_pBottleBack);
    
    m_pClippingNode = ClippingNode::create(Sprite::create("content/make/flavor/taste/mask.png"));
    this->addChild(m_pClippingNode);
    m_pClippingNode->setPosition(Vec2(0, -21));
    m_pClippingNode->setAlphaThreshold(0.5);
    
//    m_pMask = Sprite::create("content/make/flavor/taste/mask.png");
//    m_pMask->retain();
...
//    m_pRender->setPosition(Vec2(0, -21));
    ...
    m_pLid = Sprite::create("content/make/flavor/cup_lid.png");
    this->addChild(m_pLid, 4);
    m_pLid->setPosition(Vec2(0.5, 82));
    
    m_pBottleFront = Sprite::create("content/make/flavor/cup_on.png");
...
//    m_pRender->end();
    ...
    ostrTag<<"content/make/flavor/taste_brand/"<<index+1<<".png";
    m_pTag = Sprite::create(ostrTag.str());
    this->addChild(m_pTag,6);
    m_pTag->setPosition(Vec2(0, -12));
    
    std::stringstream ostrLabel;
    ostrLabel<<"content/make/flavor/taste_brand1/"<<index+1<<".png";
    m_pLabel = Sprite::create(ostrLabel.str());
    m_pLid->addChild(m_pLabel);
    m_pLabel->setPosition(Vec2(55, 33));
}
...
//                                                          m_pRender->runAction(ScaleTo::create(1, 0.6,0.5));
//                                                          m_pRender->runAction(MoveBy::create(1, Vec2(0, 40)));

...
bool CottonMachine::init()
{
    ...
    m_nFlavor = 0;
    m_pMaskMiddle = Sprite::create("content/make/cotton/2/middle_mask.png");
    m_pMaskOut = Sprite::create("content/make/cotton/2/mask2.png");
    
//    m_pShadow = Sprite::create("content/make/cotton/2/shadow.png");
//    this->addChild(m_pShadow, 0);
//    m_pShadow->setPosition(Vec2(-110, -90));
    
    m_pBodyBack = Sprite::create("content/make/cotton/2/machine_after.png");
    this->addChild(m_pBodyBack, 0);
    
    m_pBodyMiddle = Sprite::create("content/make/cotton/2/middle_animation1.png");
    this->addChild(m_pBodyMiddle, 1);
    m_pBodyMiddle->setPosition(Vec2(0,50));
    
    m_pBodyFront = Sprite::create("content/make/cotton/2/machine_before.png");
    this->addChild(m_pBodyFront, 10);
    
    m_pSwitch = Button::create("content/make/cotton/2/machine_off.png","content/make/cotton/2/machine_off.png","content/make/cotton/2/machine_off.png");
    this->addChild(m_pSwitch, 11);
    m_pSwitch->setPosition(Vec2(5, -200));
    ...
    m_pMiddleClp->setPosition(Vec2(0, 60+50));
    
    m_pOutClp = ClippingNode::create(m_pMaskOut);
    this->addChild(m_pOutClp, 6);
    m_pOutClp->setPosition(Vec2(0, 240));
    ...
    ostrFront<<"content/make/cotton/2/before/"<<m_nFlavor+1<<"_4.png";
    std::stringstream ostrBack ;
    ostrBack<<"content/make/cotton/2/after/"<<m_nFlavor+1<<"_4.png";
    m_pSilkBack = Sprite::create(ostrBack.str());
    this->addChild(m_pSilkBack);
    m_pSilkBack->setPosition(Vec2(0, 50+50));
    
    m_pSilkFront = Sprite::create(ostrFront.str());
    this->addChild(m_pSilkFront);
    m_pSilkFront->setLocalZOrder(5);
    m_pSilkFront->setPosition(Vec2(0, 50+50));
...
void CottonMachine::_turnOn(bool on)
{
    if (on) {
        ...
        m_pSwitch->loadTextures("content/make/cotton/2/machine_on.png", "content/make/cotton/2/machine_on.png", "content/make/cotton/2/machine_on.png");
        m_pBodyMiddle->stopAllActions();
        m_pBodyMiddle->runAction(RepeatForever::create(AnimationHelp::createAnimate("content/make/cotton/2/middle_animation", 1, 2,false,true,0.01)));
        ...
        AudioHelp::getInstance()->stopLoopEffect();
        m_pSwitch->loadTextures("content/make/cotton/2/machine_off.png", "content/make/cotton/2/machine_off.png");
        m_pBodyMiddle->stopAllActions();
    }
    if (onSwitchTurnOn) {
        onSwitchTurnOn(on);
...
void CottonMachine::_makeSilk()
{
    ...
    std::stringstream ostrFront ;
    ostrFront<<"content/make/cotton/2/before/"<<m_nFlavor+1<<"_";
    std::stringstream ostrBack ;
    ostrBack<<"content/make/cotton/2/after/"<<m_nFlavor+1<<"_";
...
bool CottonMachine::makeCotton()
{
    ...
    std::stringstream ostrFront ;
    ostrFront<<"content/make/cotton/2/before/"<<m_nFlavor+1<<"_"<<4-m_nCottonStep<<".png";
    std::stringstream ostrBack ;
    ostrBack<<"content/make/cotton/2/after/"<<m_nFlavor+1<<"_"<<4-m_nCottonStep<<".png";

...
void GameUILayoutLayer::showNextLayout2(bool animate,bool up)
{
    ...
    if (!animate) {
        CMVisibleRect::setPosition(m_pNext, 10, 210+(up?0:100),kBorderRight,up?kBorderTop:kBorderBottom);
    }else{
        CMVisibleRect::setPosition(m_pNext, 10,210+(up?0:100),kBorderRight,up?kBorderTop:kBorderBottom);
        m_pNext->runAction(RepeatForever::create(Sequence::create(EaseBounceIn::create(ScaleTo::create(0.5, 1.1)),
                                                                  ScaleTo::create(0.5, 1),
...
void GameUILayoutLayer::showResetLayout(bool animate,bool up)
{
    if (!m_pReset) {
        if (up) {
            ...
            m_pReset = _createButton("content/common/button/btn_reset2.png");
        }
    ...
    if (!animate) {
        CMVisibleRect::setPosition(m_pReset, 10, 90+20+(up?0:140),kBorderRight,up?kBorderTop:kBorderBottom);
    }else{
        CMVisibleRect::setPosition(m_pReset, 10+(up?0:50), 90+20+(up?0:150),kBorderRight,up?kBorderTop:kBorderBottom);
...
void GameUILayoutLayer::showShareUILayout(bool animate)
{
    ...
    CMVisibleRect::setPosition(m_pPhoto, 10, 110,kBorderRight,kBorderTop);
...
void GameUILayoutLayer::showMenuUILayout(bool animate)
{
    ...
    CMVisibleRect::setPosition(m_pMenu, 10,110,kBorderLeft,kBorderTop);

...
bool MachineNode::init()
{
    ...
    Node* pMachine = CSLoader::createNode("res/MachineNode.csb");
    ...
    Node* pButton = pMachine->getChildByName("machine_on");

    m_pBody = Sprite::create("content/make/snowcone/1/machine0.png");
    this->addChild(m_pBody);
    m_pBody->setPosition(pBody->getPosition());
    
    m_pBodyFront = Sprite::create("content/make/snowcone/1/machine1.png");
    ...
    m_pBox = Sprite::create("content/make/snowcone/1/box0.png");
    m_pBoxNode->addChild(m_pBox);
    
    m_pBoxFront = Sprite::create("content/make/snowcone/1/box1.png");
    m_pBoxNode->addChild(m_pBoxFront,5);
    
    m_pCap = Sprite::create("content/make/snowcone/1/cap.png");
    ...
    m_pMask = Sprite::create("content/make/snowcone/1/box_mask.png");
    m_pIceClipping = ClippingNode::create(m_pMask);
    m_pIceClipping->setAlphaThreshold(0.5);
    m_pIceClipping->setPosition(Vec2(0, -70));
    m_pBoxNode->addChild(m_pIceClipping,1);
    
    m_pIce = Sprite::create("content/make/snowcone/1/ice.png");
    m_pIceClipping->addChild(m_pIce);
    m_pIce->setPosition(Vec2(0, -m_pMask->getContentSize().height));
    
    m_pButton = Button::create("content/make/snowcone/1/machine_on.png","content/make/snowcone/1/machine_on.png","content/make/snowcone/1/machine_on.png");
...
//        m_bTouchEnable = false;
        m_bIsOpen = !m_bIsOpen;
        if (m_bIsOpen) {
            AudioHelp::getInstance()->playEffect("open_snowcone_machine.mp3");
            if (onStateCallback) {
                onStateCallback(eStateCapOpen);
            }
            m_pCap->runAction(RotateBy::create(0.5, -156));
        }else{
            AudioHelp::getInstance()->playEffect("close_snowcone_machine.mp3");
            if (onStateCallback) {
...
void MachineNode::addIce(Sprite* pIce,Vec2 wolrdPos)
{
    ...
    pIce->runAction(Sequence::create(DelayTime::create(0.3),
                                     JumpTo::create(0.8, Vec2(90,350), 50, 1),
...
void MachineNode::addUnit(int index)
{
    switch (index) {
        case 0:
        {
            ...
            m_pBody = Sprite::create("content/make/snowcone/1/machine0_1.png");
            this->addChild(m_pBody);
            
            m_pBodyFront = Sprite::create("content/make/snowcone/1/machine0_2.png");
            this->addChild(m_pBodyFront,10);
        ...
        case 1:
        {
            ...
            m_pBowl = Sprite::create("content/make/snowcone/1/machine1_1.png");
            this->addChild(m_pBowl);
            
            m_pBowlFront = Sprite::create("content/make/snowcone/1/machine1_2.png");
...
//            m_pBowl->setPhysicsBody(body);
        ...
        case 2:
        {
            ...
            m_pCone = Sprite::create("content/make/snowcone/1/cone1_0.png");
            this->addChild(m_pCone);
            
            m_pConeFront = Sprite::create("content/make/snowcone/1/cone1_1.png");
        ...
        case 3:
        {
            m_pStick = Sprite::create("content/make/snowcone/1/machine2_2.png");
...
//            m_pStick->setPhysicsBody(body);
        ...
        case 4:
        {
            ...
            m_pCover = Sprite::create("content/make/snowcone/1/machine2_1.png");
...
//            m_pCover->setPhysicsBody(body);
        ...
        {
            if(!m_pIceClipping){
                m_pMask = Sprite::create("content/make/snowcone/1/ice3.png");
                m_pIceClipping = ClippingNode::create(m_pMask);
                m_pIceClipping->setAlphaThreshold(0.5);
            ...
            if (!m_pIce) {
                m_pIce = Sprite::create("content/make/snowcone/1/ice3.png");
                m_pIceClipping->addChild(m_pIce);
...
//        m_pButton->setTouchEnabled(false);
        ...
        if (m_bIsOn) {
            ...
            m_pButton->loadTextures("content/make/snowcone/1/machine_on_h.png", "content/make/snowcone/1/machine_on_h.png","content/make/snowcone/1/machine_on_h.png");
            _doWork();
        }else{
            if (onStateCallback) {
            ...
            _stopWork();
            m_pButton->loadTextures("content/make/snowcone/1/machine_on.png", "content/make/snowcone/1/machine_on.png","content/make/snowcone/1/machine_on.png");
        }
    }
}
...
{
    updateIce(0.1);
    AudioHelp::getInstance()->playLoopEffect("conemachine_work.mp3");
    ...
    if (!pParticle) {
        ...
        pParticle->setPosition(Vec2(0, m_pBox->getContentSize().height*0.3));
        m_pIceClipping->addChild(pParticle,2);
...
{
    this->stopAllActions();
    ParticleSystemQuad* pParticle = (ParticleSystemQuad*)m_pIceClipping->getChildByName("ice");
    if (pParticle) {

...
void ShareScene::_sendEmail()
{
    ...
    pImage->autorelease();
    SSCInternalLibManager::getInstance()->sendEmailAndFilePic("Cotton Candy!",
                           "<p>Look at this Cotton Candy I just made. So yummy， tons of flavors and decorations to have fun. Let's play together.</p>  <p><a href=‘http://itunes.apple.com/app/id1153448365’>http://itunes.apple.com/app/id1153448365</a></p>",
    ...
    pImage->autorelease();
    SSCInternalLibManager::getInstance()->sendEmailAndFilePic("Cotton Candy!",
                                                              "Look at this Cotton Candy I just made. So yummy， tons of flavors and decorations to have fun. Let's play together.",
                                                              (SSCFileUtility::getStoragePath()+"/shotscreen.png").c_str());

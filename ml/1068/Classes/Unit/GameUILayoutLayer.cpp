...
//        CMVisibleRect::setPosition(m_pHomeRate, 15, 15,kBorderLeft,kBorderTop);
        ...
        CMVisibleRect::setPositionAdapted(m_pHomeStart, 320, 240+150);
...
void GameUILayoutLayer::showResetLayout(bool animate)
{
    ...
    if (!animate) {
        CMVisibleRect::setPosition(m_pReset, 10,10,kBorderLeft,kBorderTop);
    }else{
        CMVisibleRect::setPosition(m_pReset, 10, 10,kBorderLeft,kBorderTop);
...
////    CMVisibleRect::setPositionAdapted(m_pFav, 900, 480,kBorderRight,kBorderTop);
    ...
    CMVisibleRect::setPosition(m_pEmail, 10, 120,kBorderRight,kBorderTop);

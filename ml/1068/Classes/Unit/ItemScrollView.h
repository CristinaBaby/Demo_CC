...
public:
    static ItemCell* create(const std::string bgPath,const std::string bgHighlight,const std::string frontHighlight,const std::string btn,const std::string lock);
    bool init(const std::string bgPath,const std::string bgHighlight,const std::string frontHighlight,const std::string btn,const std::string lock);

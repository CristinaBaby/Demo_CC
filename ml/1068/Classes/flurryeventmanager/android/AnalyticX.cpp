...
void AnalyticX::flurryLogEvent(const char * eventName) {
    ...
    bool isHave = cocos2d::JniHelper::getStaticMethodInfo(minfo,"com/common/AnalyticX/AnalyticXBridge","Bridge", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V"); 
...
const char * AnalyticX::flurryGetFlurryAgentVersion() {
    ...
    bool isHave = cocos2d::JniHelper::getStaticMethodInfo(minfo,"com/common/AnalyticX/AnalyticXBridge","flurryGetAgentVersion", "()I"); 
...
void AnalyticX::flurrySetSessionContinueSeconds(int seconds) {
    ...
    bool isHave = cocos2d::JniHelper::getStaticMethodInfo(minfo,"com/common/AnalyticX/AnalyticXBridge","flurrySetSessionContinueSecond", "(I)V"); 
...
void AnalyticX::flurrySetAge(int age) {
    ...
    bool isHave = cocos2d::JniHelper::getStaticMethodInfo(minfo,"com/common/AnalyticX/AnalyticXBridge","flurrySetAge", "(I)V"); 

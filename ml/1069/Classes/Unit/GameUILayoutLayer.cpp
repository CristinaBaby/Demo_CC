...
void GameUILayoutLayer::showBackLayout(bool animate)
{
    ...
    if (!animate) {
        CMVisibleRect::setPosition(m_pBack, 10, 100,kBorderLeft,kBorderBottom);
    }else{
        CMVisibleRect::setPosition(m_pBack, 10, 100,kBorderLeft,kBorderBottom);
...
void GameUILayoutLayer::showResetLayout(bool animate)
{
    ...
    if (!animate) {
        CMVisibleRect::setPosition(m_pReset, 144,10,kBorderRight,kBorderTop);
    }else{
        CMVisibleRect::setPosition(m_pReset, 144,10,kBorderRight,kBorderTop);
...
void GameUILayoutLayer::showEatLayout(bool animate)
{
    ...
    if (!m_pEat) {
        m_pEat = _createButton("content/common/button/btn_share.png");
    ...
    if (!animate) {
        CMVisibleRect::setPosition(m_pEat, 380, 120);
    }else{
        CMVisibleRect::setPosition(m_pEat, 380, 120+50);
        m_pEat->runAction(Sequence::create(EaseBackOut::create(JumpBy::create(1, Vec2(0, -20), 250, 1)),
                                           CallFunc::create([=](){
...
void GameUILayoutLayer::showSaleLayout(bool animate)
{
    ...
    if (!animate) {
        CMVisibleRect::setPosition(m_pSale, 600, 120);
    }else{
        CMVisibleRect::setPosition(m_pSale, 600, 120+50);
        m_pSale->runAction(Sequence::create(EaseBackOut::create(JumpBy::create(1, Vec2(0, -20), 250, 1)),
                                            CallFunc::create([=](){
...
////    CMVisibleRect::setPositionAdapted(m_pFav, 900, 480,kBorderRight,kBorderTop);
    CMVisibleRect::setPosition(m_pPhoto, 10, 220,kBorderLeft,kBorderTop);
    CMVisibleRect::setPosition(m_pEmail, 10, 110,kBorderLeft,kBorderTop);

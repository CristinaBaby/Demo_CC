...
Layer* DecorateManager::getUneatableLayer()
{
    ...
    RenderTexture* rt = RenderTexture::create(visibleSize.width*1.4, visibleSize.height);
...
MakeEatLayer* DecorateManager::getEatableLayer()
{
    ...
    MyRenderTexture* rt = MyRenderTexture::create(visibleSize.width*1.4, visibleSize.height*1.4);
    ...
    MyRenderTexture* rt2 = MyRenderTexture::create(visibleSize.width*1.4, visibleSize.height*1.4);
...
{
    Layer* pLayer = Layer::create();
    RenderTexture* rt = RenderTexture::create(visibleSize.width*1.4, visibleSize.height*1.4);
    rt->setPosition(Vec2(visibleSize.width*0.7, visibleSize.height*0.7));
    rt->begin();
    if (m_pAllUneatFrontLayer) {

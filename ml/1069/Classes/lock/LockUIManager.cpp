...
//    Director::getInstance()->getEventDispatcher()->dispatchCustomEvent(CSIgnoreAllTouchNotification);
    ...
    dialog->setContentText("there is problem with internet connection and try later");
...
//    Sprite* bg = Sprite::create("ui/Rewarded/Rewarded_bg.png");
//    dialogNode->addChild(bg);
//    auto shopButton = Button::create("ui/Rewarded/Rewarded_shop.png");
//    shopButton->setPosition(Vec2(362, 44));
...
//    
//    auto cancelButton = Button::create("ui/Rewarded/Rewarded_cancel.png");
//    bg->addChild(cancelButton);
//    cancelButton->setPosition(Vec2(116, 44));
...
//        cancelButton->setPosition(Vec2(362, 44));
//    

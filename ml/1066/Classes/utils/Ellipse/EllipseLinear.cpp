...
EllipseLinear *EllipseLinear::create(float dt, float a, float b, Point center){
...
EllipseLinear::EllipseLinear(float a, float b, Point center){
    _a = a;
    _b = b;
    _center = center;
}
...
void EllipseLinear::update(float t){
    ...
    Point position = _center + Point(x, y);

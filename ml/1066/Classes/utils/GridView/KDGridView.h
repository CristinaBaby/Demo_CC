...
public:
    ...
    void setViewMoveCall(const std::function<void(int,Touch*,Event*)>& fn)
    {
        m_fnMoveCall = fn;
    }
    void setTouchDownCall(const std::function<void(int,Touch*,Event*)>& fn)
    {
        m_fnTouchDownCall = fn;
    }
    void setTouchMoveCall(const std::function<void(int,Touch*,Event*)>& fn)
    {
        m_fnTouchMoveCall = fn;
    }
    void setTouchEndCall(const std::function<void(int,Touch*,Event*)>& fn)
    {
        m_fnTouchEndCall = fn;
    }
    void setSwallowEvent(bool isSwallow);
    void setLock(bool isLock);
    
    float getAdjustToCenterOfSceen(int index);
...
public:
    Vector<MenuItem*> getMenuItemsVector();
 
private:
    std::function<void(int,MenuItem*,int)>  m_fnClickCall;
    std::function<void(int,Touch*,Event*)>  m_fnMoveCall;
    std::function<void(int,Touch*,Event*)>  m_fnTouchDownCall;
    std::function<void(int,Touch*,Event*)>  m_fnTouchMoveCall;
    std::function<void(int,Touch*,Event*)>  m_fnTouchEndCall;

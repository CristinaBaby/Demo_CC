...
public:
    ...
    void updateVideoLockedString(std::string type);
    void _saveVideoData(std::string key,int index,time_t time);
    ...
    //    口味（下标0开始）
    int m_nFlavorIndex = 4;
    int m_nShapeIndex = 0;
    int m_nPlateIndex = 1;
    std::string m_sFlavorStr = "";
    std::string m_sFlavorCakeStr = "";
    std::string m_sFlavorCreamStr = "";
    std::string m_sFlavorFruitStr = "";

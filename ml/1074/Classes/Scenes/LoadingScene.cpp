...
//        GameDataManager::getInstance()->m_nShapeIndex = 0;
//        GameDataManager::getInstance()->m_sFlavorStr = "1,7,4,6,2,7,4,6,2,6,2,7";
//        GameDataManager::getInstance()->m_sFlavorCakeStr = "4";
//        GameDataManager::getInstance()->m_sFlavorCreamStr = "1";

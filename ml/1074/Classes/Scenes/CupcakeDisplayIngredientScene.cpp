...
#include "CupcakeDisplayIngredientScene.h"
...
CupcakeDisplayIngredientScene::CupcakeDisplayIngredientScene()
{
...
bool CupcakeDisplayIngredientScene::init()
{
    ...
    //    bg
    m_pBg = Sprite::create("content/make/cupcake/common/bg.jpg");
...
//    total = 1;
    this->runAction(Sequence::create(DelayTime::create(1),
                                     CallFunc::create([=](){
        Sprite* pFood =Sprite::create(localPath("show_cupcake.png"));
        ...
        pItem->runAction(Sequence::create(DelayTime::create(1+0.8*i),
            ...
            if (i==total-1) {
                ...
                pParticle->setPosition(visibleSize*0.5);
                                          ...
                                          CallFunc::create([=](){
            if (i==total-1) {
                SceneManager::replaceTheScene<CupcakeMixFlourScene>();
            }
        }), NULL));
    }
    return true;
...
void CupcakeDisplayIngredientScene::onEnter()
{
    ExtensionScene::onEnter();
    Analytics::getInstance()->sendScreenEvent(Flurry_EVENT_Cupcake);
}

void CupcakeDisplayIngredientScene::onShopItemBuy(cocos2d::Ref *pRef)
{
}

void CupcakeDisplayIngredientScene::dragNodeTouchBegin(DragNode* pDragNode,Point worldPoint)
{
}

void CupcakeDisplayIngredientScene::dragNodeTouchMoved(DragNode* pDragNode,Point worldPoint)
{
}

void CupcakeDisplayIngredientScene::dragNodeTouchEnded(DragNode* pDragNode,Point worldPoint){
    
}

void CupcakeDisplayIngredientScene::dragNodeClicked(DragNode* pDragNode,Point worldPoint)
{
    
}

#pragma mark - initData
void CupcakeDisplayIngredientScene::_initData()
{

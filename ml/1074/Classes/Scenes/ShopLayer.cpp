...
//    pRootNode->addChild(pBg);
    ...
    Sprite* pLogo = Sprite::create(localPath("store_frame2.png"));
    CMVisibleRect::setPosition(pLogo, pShopLayer->getChildByName("store_frame2")->getPosition());
    pRootNode->addChild(pLogo,-2);
    
    Sprite* pPlatform = Sprite::create(localPath("store_frame1.png"));
    CMVisibleRect::setPosition(pPlatform, pShopLayer->getChildByName("store_frame1")->getPosition());
    pRootNode->addChild(pPlatform);
    ...
    pRootNode->addChild(pRestoreBtn,-1);

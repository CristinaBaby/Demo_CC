...
void GameUILayoutLayer::showHomeUILayout(bool animate)
{
    ...
    if (!animate) {
        ...
        CMVisibleRect::setPositionAdapted(m_pHomeStart, 320, 280);
        ...
        m_pHomeStart->runAction(Sequence::create(DelayTime::create(0.5),
            ...
            m_pHomeStart->runAction(RepeatForever::create(Sequence::create(DelayTime::create(3),
                                                                           Spawn::create(JumpBy::create(5, Vec2::ZERO, 10, 2),
                                                                                         Sequence::create(ScaleTo::create(2,1.1),
                                                                                                          DelayTime::create(1),
                                                                                                          
                                                                                                          ScaleTo::create(2,1.1), NULL),
                                                                                         NULL), NULL)));
        }),
                                                 NULL));
    }
...
void GameUILayoutLayer::showNextLayout(bool animate,bool up)
{
    ...
    if (!animate) {
        CMVisibleRect::setPosition(m_pNext, 10, 20+(up?0:100),kBorderRight,up?kBorderTop:kBorderBottom);
    }else{
        CMVisibleRect::setPosition(m_pNext, 10, 20+(up?0:100),kBorderRight,up?kBorderTop:kBorderBottom);
...
void GameUILayoutLayer::showNextLayout2(bool animate,bool up)
{
    ...
    if (!animate) {
        CMVisibleRect::setPosition(m_pNext, 10, 120+(up?0:100),kBorderRight,up?kBorderTop:kBorderBottom);
    }else{
        CMVisibleRect::setPosition(m_pNext, 10,120+(up?0:100),kBorderRight,up?kBorderTop:kBorderBottom);
        m_pNext->runAction(RepeatForever::create(Sequence::create(EaseBounceIn::create(ScaleTo::create(0.5, 1.1)),
                                                                  ScaleTo::create(0.5, 1),
...
void GameUILayoutLayer::showBackLayout(bool animate,bool up)
{
    ...
    if (!animate) {
        CMVisibleRect::setPosition(m_pBack, 10, 20+(up?0:100),kBorderLeft,up?kBorderTop:kBorderBottom);
    }else{
        CMVisibleRect::setPosition(m_pBack, 10, 20+(up?0:100),kBorderLeft,up?kBorderTop:kBorderBottom);
...
void GameUILayoutLayer::showShareUILayout(bool animate)
{
    ...
    CMVisibleRect::setPosition(m_pPhoto, 10, 20,kBorderRight,kBorderTop);
    //    CMVisibleRect::setPosition(m_pEmail, 10, 80,kBorderRight,kBorderTop);
    CMVisibleRect::setPosition(m_pHome, 10, 20,kBorderLeft,kBorderTop);
...
void GameUILayoutLayer::showMenuUILayout(bool animate)
{
    ...
    CMVisibleRect::setPosition(m_pMenu, 10,100,kBorderLeft,kBorderTop);

...
public:
    ...
    static void showBackInOut(Node* node, float delayTime,ShowDirection type, std::function<void()> actionEnd = nullptr,float time=0.75);
    static void showBouce(Node* node, Vec2 endPosiont,ShowDirection type, std::function<void()> actionEnd = nullptr,float time=1);
    static void showBezier(Node* node, Vec2 endPosiont,ShowDirection type,float delaytime = 0.0, std::function<void()> actionEnd = nullptr,float time = 0.65);

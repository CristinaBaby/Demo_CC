...
//    removeGuide();
    ...
    m_pPoint = Sprite::create("content/common/tip/kick.png");
...
{
//    removeGuide();
    m_pArrow = Sprite::create("content/common/tip/icon_tilt.png");
    this->addChild(m_pArrow);
    m_pArrow->setPosition(position);
    m_pArrow->setVisible(true);
...
void GuideLayer::showGuide(std::string path, cocos2d::Vec2 position,float rotate,float delayTime)
{
//    removeGuide();

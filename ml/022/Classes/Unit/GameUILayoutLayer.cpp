...
void GameUILayoutLayer::showHomeUILayout(bool animate)
{
    ...
    if (!m_pHomeStart) {
        m_pHomeStart = _createButton("content/start/btn_start0.png");
    ...
    if (!animate) {
        ...
        CMVisibleRect::setPosition(m_pHomePolicy, 5, 10,kBorderRight,kBorderTop);
        //        CMVisibleRect::setPosition(m_pHomeRate, 15, 15,kBorderLeft,kBorderTop);
                                                 ...
                                                 CallFunc::create([=]()
                                                                  {
                                                                      ...
                                                                      m_pHomeStart->runAction(RepeatForever::create(Sequence::create(DelayTime::create(0.3),
                                                                                                                                     CallFunc::create([=](){
                                                                          m_pHomeStart->loadTextures("content/start/btn_start1.png", "content/start/btn_start1.png");
                                                                      }),
                                                                                                                                     DelayTime::create(0.3),
                                                                                                                                     CallFunc::create([=](){
                                                                          m_pHomeStart->loadTextures("content/start/btn_start0.png", "content/start/btn_start0.png");
                                                                      }), NULL)));
                                                                  }),
                                                 NULL));
    }
...
void GameUILayoutLayer::showResetLayout(bool animate)
{
    ...
    if (!animate) {
        CMVisibleRect::setPosition(m_pReset, 10,110,kBorderRight,kBorderTop);
    }else{
        CMVisibleRect::setPosition(m_pReset, 10,110,kBorderRight,kBorderTop);
...
void GameUILayoutLayer::showEatAgainLayout(bool isDrink,bool animate)
{
    ...
    if (!animate) {
        ...
        CMVisibleRect::setPositionAdapted(m_pEatAgain, 320, 500+visibleSize.height);
...
//    }
    ...
    CMVisibleRect::setPosition(m_pPhoto, 10, 210,kBorderRight,kBorderTop);
//    CMVisibleRect::setPosition(m_pEmail, 10, 210,kBorderRight,kBorderTop);
    CMVisibleRect::setPosition(m_pHome, 10, 110,kBorderRight,kBorderTop);
...
void GameUILayoutLayer::showCointLayout(bool animate){
    ...
    if (!m_pCointLabel) {
        ...
        m_pCointLabel->setPosition(Vec2(125, 35));
    }

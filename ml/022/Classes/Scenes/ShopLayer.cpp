...
//    pRootNode->addChild(pBg);
    ...
    Sprite* pLogo = Sprite::create(localPath("shop1.png"));
    CMVisibleRect::setPosition(pLogo, pShopLayer->getChildByName("shop1")->getPosition());
    pRootNode->addChild(pLogo);
    
    Sprite* pPlatform = Sprite::create(localPath("shop2.png"));
    CMVisibleRect::setPosition(pPlatform, pShopLayer->getChildByName("shop2")->getPosition());
    pRootNode->addChild(pPlatform,11);
    ...
    CMVisibleRect::setPosition(pBackBtn, pShopLayer->getChildByName("close")->getPosition());
    ...
    pRestoreBtn->addTouchEventListener([=](Ref* ref,Widget::TouchEventType type){
        if (type==Widget::TouchEventType::ENDED) {
            ...
            pRestoreBtn->runAction(Sequence::create(DelayTime::create(0.5),
                                                    CallFunc::create([=](){

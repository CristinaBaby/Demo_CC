...
bool ShopMiniLayer::init(bool dec)
{
    ...
    //    bg
    Sprite* pBg = Sprite::create(localPath("mini/mini_store.png"));
    CMVisibleRect::setPosition(pBg, pShopMiniLayer->getChildByName("mini_store")->getPosition());
    ...
    Button* pRestoreBtn = Button::create(localPath("mini/pack_shop.png"));
    ...
    CMVisibleRect::setPosition(pRestoreBtn, pShopMiniLayer->getChildByName("pack_shop")->getPosition());
    
    Button* pRewardBtn = Button::create(localPath("mini/btn_getfree.png"));
    ...
    CMVisibleRect::setPosition(pRewardBtn, pShopMiniLayer->getChildByName("btn_getfree")->getPosition());

...
void DecorateManager::_updateFinishedPercent()
{
    ...
    //        m_bFinishedEat = true;
    //    }
    if ((curPercent*100>=m_nEatPercent*percent || percent==0) && (curPercent1*100>=m_nEatPercent*percent1 || percent1==0)&& (curPercent2>80 || curPercent2 ==0) && bDrinkFinish && bSauceFinish) {
        m_bFinishedEat = true;
    }
}

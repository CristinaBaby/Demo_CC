...
#ifndef __CCATS1044_BeachFoodParty__SnowDecorationLayer__
#define __CCATS1044_BeachFoodParty__SnowDecorationLayer__
...
class GameLayer;
class SnowDecorationLayer:public BaseLayer{
    
public:
    SnowDecorationLayer(GameLayer* gameLayer);
    ~SnowDecorationLayer();
public:
    static SnowDecorationLayer* create(GameLayer* gameLayer);
    virtual bool init();
...
//    std::string m_sTouchPath;
    ...
    int m_iUnitScrollIndex;
};
#endif /* defined(__CCATS1044_BeachFoodParty__SnowDecorationLayer__) */

...
SnowEatLayer::SnowEatLayer()
{
    
}
SnowEatLayer::~SnowEatLayer()
{
//    log("G_Snow_ShapeIce~SnowEatLayer----%d",G_Snow_ShapeIce->getReferenceCount());
//    CC_SAFE_RELEASE_NULL(G_Snow_ShapeIce);
}
bool SnowEatLayer::init()
{
    bool isInit=false;
    do{
...
void SnowEatLayer::initUI()
{
    ...
    kAdapterScreen->setExactPosition(m_pCup, 320, 223);
    ...
    if(G_Snow_BGNum != -1){
        ...
        pBgSprite->setTexture(__String::createWithFormat("images/dec/category/bg/bg%d.jpg",G_Snow_BGNum)->getCString());
        
        
    }
    
//    if (G_Snow_SpoonNum != -1) {
//        
//        auto spoon = Sprite::create(__String::createWithFormat("images/dec/category/spoons/spoons%d.png",G_Snow_SpoonNum)->getCString());
//        kAdapterScreen->setExactPosition(spoon, 320 + 200, 480);
//        this->addChild(spoon, 20);
//    
//    }
    ...
    foodLayer->removeFromParent();
    if (foodLayer->getChildByTag(333)) {
        dynamic_cast<ToolSprite*>(foodLayer->getChildByTag(333))->cancelEvent(true);
    }
    ...
    this->scheduleOnce(schedule_selector(SnowEatLayer::getScribbleCallback), 0.2f);

    
}
void SnowEatLayer::initMenu()
{
    auto favBtn = ui::Button::create("images/button/btn_share.png");
    favBtn -> addTouchEventListener(CC_CALLBACK_2(SnowEatLayer::touchEvent, this));
    ...
    homeBtn -> addTouchEventListener(CC_CALLBACK_2(SnowEatLayer::touchEvent, this));
    ...
    backBtn -> addTouchEventListener(CC_CALLBACK_2(SnowEatLayer::touchEvent, this));
    ...
    nextBtn -> addTouchEventListener(CC_CALLBACK_2(SnowEatLayer::touchEvent, this));
...
void SnowEatLayer::onEnter()
{
    BaseLayer::onEnter();
    
    cocos2d::CCNotificationCenter::getInstance()->addObserver(this,callfuncO_selector(SnowEatLayer::eatOver), "eatOver", NULL);
}
void SnowEatLayer::eatOver(Ref*)
{
    log("eatOver");
    node->disable();
    node->removeFromParent();
    node = nullptr;
    this->unschedule(schedule_selector(SnowEatLayer::getScribbleCallback));
...
void SnowEatLayer::onEnterTransitionDidFinish()
{
    BaseLayer::onEnterTransitionDidFinish();
//    G_Snow_ShapeIce->setVisible(false);
}

void SnowEatLayer::onExit()
{
    BaseLayer::onExit();
    cocos2d::CCNotificationCenter::getInstance()->removeObserver(this, "eatOver");

}
void SnowEatLayer::onTouchDown(ToolSprite* toolSprite,Touch *pTouch)
{
    m_pEatAgain->cancelEvent(true);
...
//    node = nullptr;
    this->scheduleOnce(schedule_selector(SnowEatLayer::getScribbleCallback), 2.0f);
    
}
void SnowEatLayer::onTouchUp(ToolSprite* toolSprite,Touch *pTouch)
{
    
    
}
void SnowEatLayer::onBtnCallBack(Ref* sender)
{
    
}

void SnowEatLayer::touchEvent(Ref *obj , Widget::TouchEventType type)
{
        ...
        case ui::Widget::TouchEventType::ENDED:
        {
            switch (btn->getTag()) {
                case KFAVORITEBUTTON:
                {
                    ...
                    scheduleOnce(schedule_selector(SnowEatLayer::saveToPhoto), 0.01f);
                ...
                case KBACKBUTTON:
                {
                    ...
                    if(G_Snow_ShapeIce){
                        G_Snow_ShapeIce->setVisible(true);
                    }
                ...
                case kNEXTBUTTON:
                {
                    ...
                    if (UserDefault::getInstance()->getIntegerForKey(IceCream, 0) != 2) {
                        UserDefault::getInstance()->setIntegerForKey(IceCream, 1);
...
void SnowEatLayer::onNegativeClick(void*)
{
    
}

void SnowEatLayer::getScribbleCallback(float ft)
{
...
void SnowEatLayer::onPositiveClick(void* type)
{
...
void SnowEatLayer::saveToPhoto(float ft)
{
    Image* image1 = m_pFavoriteTexture->newImage();
    CFSystemFunction sys;
    sys.saveToAlbum(image1, CC_CALLBACK_1(SnowEatLayer::addFavoriteCallback, this));}
void SnowEatLayer::addFavoriteCallback(bool isSuc)
{
...
// 监听Android返回键事件
void SnowEatLayer::onKeyReleasedCallBack(EventKeyboard::KeyCode keyCode,Event* event)
{

...
#ifndef __CCATS1044_BeachFoodParty__SnowEatLayer__
#define __CCATS1044_BeachFoodParty__SnowEatLayer__
...
USING_NS_CC;
using namespace std;
class SnowEatLayer:public BaseLayer,public ToolSpriteDelegate{
...
#endif /* defined(__CCATS1044_BeachFoodParty__SnowEatLayer__) */

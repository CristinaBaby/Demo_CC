...
bool SettingLayer::init()
{
    ...
    Sprite* closeSprite = Utils::getUISprite("images/button/btn_close@2x.png");
   
    ControlButton* btnClose = ControlButton::create(Scale9Sprite::create("images/button/btn_close@2x.png"));
...
{
    CCLayer::onExit();
    m_Parent->m_pUIMenu->setEnabled(true);
}

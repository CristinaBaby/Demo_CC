...
{
    _selectedControl->setPosition((_selectedControl->getContentSize().width + INTERVAL) * index + _selectedControl->getContentSize().width / 2, _selectedControl->getPositionY());
}

...
bool GameScene::init(int packIndex, int pictureIndex){
    ...
    if(Scene::init())
    {
        ...
        auto bird_left = quickGetAnimation(0, "MM", Vec2(280, 0));
        _cliperLayer->addChild(bird_left, 1);
        
        auto distance_left = Vec2(-500, 250);  //250 160
        ccBezierConfig bezier_left;
        bezier_left.controlPoint_1 = Vec2(distance_left.x * 0.25, distance_left.y * 0.3);
        bezier_left.controlPoint_2 = Vec2(distance_left.x * 0.7, distance_left.y * 0.4);
        bezier_left.endPosition = distance_left;
        
        auto bezierForward = BezierBy::create(4.5, bezier_left);
        
        auto distance_right = Vec2(460,20);
        ccBezierConfig bezier2_right;
        bezier2_right.controlPoint_1 = Vec2(distance_right.x * 0.25, distance_right.y * 0.3);
        bezier2_right.controlPoint_2 = Vec2(distance_right.x * 0.7, distance_right.y * 0.4);
        bezier2_right.endPosition = distance_right;
        
        auto bezierBack = BezierBy::create(5.5, bezier2_right);
        auto bird_right = quickGetAnimation(0, "MM", Vec2(-220, 0));
        bird_right->setScaleX(-1);
        _cliperLayer->addChild(bird_right, 1);
        
        bird_left->runAction(RepeatForever::create(Sequence::create(bezierForward, DelayTime::create(5.5f), DelayTime::create(3.5f),CallFunc::create([=](){
            bird_left->setPosition(280,0);
        }),NULL)));
        
        bird_right->runAction(RepeatForever::create(Sequence::create(DelayTime::create(6.0f), bezierBack, DelayTime::create(2.0f),CallFunc::create([=](){
            bird_right->setPosition(-220, 0);
        }),NULL)));
        
        //cloud
        auto size = Director::getInstance()->getVisibleSize();
        CloudSprite* cloud1 = CloudSprite::create("mm/cloud_1.png", CloudSprite::CloudType::Animation_1);
        cloud1->setPosition(Vec2(-50, size.height/2 - 40));
        _cliperLayer->addChild(cloud1);
        
        CloudSprite* cloud2 = CloudSprite::create("mm/cloud_1.png", CloudSprite::CloudType::Animation_2);
        cloud2->setPosition(Vec2(90, size.height/2 - 120));
        _cliperLayer->addChild(cloud2);
        
        //make the cloud under these things
        auto bg_2 = Helper::seekWidgetByName(_root, "bg-2");
        bg_2->setZOrder(BG_LAYER);
        
        auto back = Helper::seekWidgetByName(_root, "back");
        back->setZOrder(UI_LAYER);
        
        auto save = Helper::seekWidgetByName(_root, "save");
        save->setZOrder(UI_LAYER);
...
//            {
//                auto saveLayer = getChildByName("saveLayer");
//                if (saveLayer != nullptr) {
//                    removeChild(saveLayer);
//                }
//                else
//                {
...
void GameScene::onProgress(int percent)
{
    switch (percent) {
        ...
        case 2: //////////////////////////////////////////////////////////// UI ////////////////////////////////////////////////////////////
        {
            ...
            //_refresh = quickButton("refresh", _root, CC_CALLBACK_2(GameScene::onButton, this));  //scene refresh
            //_refresh->setLocalZOrder(2);
            ...
            //flower
            auto flower = quickGetAnimation(1, "MM", Vec2(12, -15));
            _center->addChild(flower, 1);
        }
            break;
        case 3: //////////////////////////////////////////////////////////// 画笔 ////////////////////////////////////////////////////////////
        {
...
void GameScene::setupScribble()
{
    ...
    _pictureScribble = ScribbleLineFrameNode::create(Size(picture->getContentSize().width, Director::getInstance()->getWinSize().height));
...
void GameScene::initAnimation()
{
    ...
    Vec2 pos((zero.x + (_backBtn->getPosition().x))/2, _backBtn->getPosition().y + 120);
    _model = make_shared<ArmatureManager>();
    _model->setScale(0.65);
    _model->setPosition(pos);
    _model->setLocalZOrder(2);
    
    _model->add("ModelWait1.ExportJson", _center);
    _model->add("ModelWait3.ExportJson", _center);
    _model->add("Paint.ExportJson", _center, Vec2(5, -16));
    
    auto armature = _model->add("ModelWait2.ExportJson", _center, Vec2(-20, 65));
    ...
    armature->getAnimation()->setFrameEventCallFunc(CC_CALLBACK_0(GameScene::onFrameEvent, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));
    armature = _model->add("Suggest.ExportJson", _center, Vec2(12, 0));
    armature->getAnimation()->setFrameEventCallFunc(CC_CALLBACK_0(GameScene::onFrameEvent, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3, std::placeholders::_4));

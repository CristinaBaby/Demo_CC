...
//    }
    ...
    if (current.getMinY() > _original.getMinY() + OFFSET_UD) {
        offset.y =  _original.getMinY() + OFFSET_UD - current.getMinY();
    }
    else if (current.getMaxY() < _original.getMaxY() - OFFSET_UD) {
        offset.y =  _original.getMaxY() - OFFSET_UD - current.getMaxY();
    }

...
ScribbleArmatureNode::ScribbleArmatureNode() : _armaturePosition(0,0), _bone(nullptr), _skinTransform(Mat4::IDENTITY){
}
...
//        _armature = armature;
        SpriteDisplayData *lDisplayData = dynamic_cast<SpriteDisplayData *>(armature->getArmatureData()->getBoneData(bone->getName())->getDisplayData(0));

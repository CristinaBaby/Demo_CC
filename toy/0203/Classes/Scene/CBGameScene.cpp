...
#define RES_PROGRESS_BG         "ui09_saving_progress_bar.png"
#define RES_PROGRESS            "ui09_saving_progress_scroll.png"
#define RES_BRUSH               "solid_brush.png"

#define RES_PENS1_BUTTON        "ui04_btn_pen.png"
#define RES_PENS1_BUTTON_H      "ui04_btn_pen_h.png"
...
bool GameScene::setupScribble()
{
    ...
    do {
        ...
        progressBg->setPosition(Vec2(305, 110));
...
void GameScene::finishPaintingSave()
{
    ...
    std::string writePath = function.getSdCardPath()+"/Toy Soldier/";

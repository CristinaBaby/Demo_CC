...
bool PackScene::init()
{
    ...
    do {
        ...
        back->addTouchEventListener(CC_CALLBACK_2(PackScene::touchDown, this));
...
void PackScene::updatePacks()
{
    _pageController->updateCellAtIndex(_pageController->getFocusPageIndex());
}

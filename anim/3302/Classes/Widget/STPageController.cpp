...
{
    CCASSERT( (std::is_convertible<colorbook::Page*, TableViewCell*>::value), "Invalid Cell Type for STPageController!");
    _selectPage = dynamic_cast<colorbook::Page *>(cell);
}
...
void STPageController::setPageControl(colorbook::PageControl* pageControl)
{

...
bool SettingLayer::init()
{
    ...
    do {
        ...
        bgmIcon->setPosition(Vec2(background->getPosition().x - bgmIcon->getContentSize().width/2 + 30, background->getPosition().y + bgmIcon->getContentSize().height/2));
        addChild(bgmIcon);
        
        //bgm on/off
        Switch *bgmSwitch = Switch::create();
        bgmSwitch->setPosition(Vec2(background->getPositionX() + bgmSwitch->getContentSize().width + 30, bgmIcon->getPositionY()));
        ...
        sfxIcon->setPosition(Vec2(background->getPosition().x - sfxIcon->getContentSize().width/2 + 30, background->getPosition().y - sfxIcon->getContentSize().height*3/2));
        addChild(sfxIcon);
        
        //sfx on/off
        Switch *sfxSwitch = Switch::create();
        sfxSwitch->setPosition(Vec2(background->getPositionX() + sfxSwitch->getContentSize().width + 30, sfxIcon->getPositionY()));

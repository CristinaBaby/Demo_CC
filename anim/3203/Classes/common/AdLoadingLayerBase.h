...
{
    //android生命周期标记。先触发全屏广告关闭，再调的applicationWillEnterForeground
    static bool s_AndroidForeGroundFlag;
public:
    ...
    static void showLoading(bool isCross, Node* parent = nullptr, int zorder = 0)
    {
        ...
        {            
            ...
            {
                if(!s_AndroidForeGroundFlag){
                    s_AndroidForeGroundFlag = ! s_AndroidForeGroundFlag;
                    return;
                }
            }

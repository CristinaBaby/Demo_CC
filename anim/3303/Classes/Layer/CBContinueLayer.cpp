...
bool ContinueLayer::init(const int packIndex, const int pictureIndex)
{
    ...
    do {
        ...
        label->setPosition(Vec2(95 + LABEL_CO_Re_OFFSET, 290));
        ...
        continueButton->setPosition(Vec2(396 + LABEL_CO_Re_OFFSET, 80));
        background->addChild(continueButton);
        
        //reset button
        auto resetButton = Sprite::create(RES_RESET_BUTTON);
        CC_BREAK_IF(!resetButton);
        resetButton->setPosition(Vec2(190 + LABEL_CO_Re_OFFSET, 80));

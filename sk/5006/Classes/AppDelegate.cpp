...
//    director->runWithScene(TransitionAnimateScene::scene());
//    director->runWithScene(SodaChooseStepScene::scene());
    
    
//    director->runWithScene(PizzaconeMakeScene::scene());
//    director->runWithScene(PizzaconeCutScene::scene());
//    director->runWithScene(PizzaconeBakeScene::scene());
//    director->runWithScene(PizzaconeDecScene::scene());
//    director->runWithScene(PizzaconeShareScene::scene());
  
//    director->runWithScene(CornDogMakeScene::scene());
//    director->runWithScene(CornDogBakeScene::scene());
//    director->runWithScene(CornDogDecScene::scene());
//    director->runWithScene(CorndogShareScene::scene());

//    director->runWithScene(CottonCandyMakeScene::scene());
//    director->runWithScene(CottonCandyDecScene::scene());
//    director->runWithScene(CottonCandyShareScene::scene());
    
//    director->runWithScene(SodaCutFruitScene::scene());
//    director->runWithScene(SodaMakeIceScene::scene());
//    director->runWithScene(SodaBlendScene::scene());
...
//    director->runWithScene(ChooseServeScene::scene());
    ...
    kAudioUtil->setEffectMusicVolume(1.f);

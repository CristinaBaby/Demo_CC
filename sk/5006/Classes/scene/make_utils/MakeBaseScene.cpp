...
bool MakeBaseScene::init()
{
    ...
    _nextButton->setPosition(CMVisibleRect::getPosition(20, 20,kBorderRight,kBorderTop));
    _nextButton->addTouchEventListener([=](Ref*, Widget::TouchEventType type){
        
        if (type == Widget::TouchEventType::BEGAN)
        {
            _nextButton->runAction(Sequence::create(RotateTo::create(0.2f, 1),
                                                     RotateTo::create(0.2f, -1),
    ...
    _resetButton = Button::create("ui/tap/reset_btn.png");
    _resetButton->loadTexturePressed("ui/tap/reset_btn.png");
    _resetButton->setAnchorPoint(Vec2(1, 1));
    _resetButton->setPosition(CMVisibleRect::getPosition(20, 120,kBorderRight,kBorderTop));
    _resetButton->addTouchEventListener([=](Ref*, Widget::TouchEventType type){
        if (type == Widget::TouchEventType::BEGAN)
        {
            _resetButton->runAction(Sequence::create(RotateTo::create(0.3f, 1),

...
using namespace std;
typedef struct _DecorationDecConfig
{
public:
    _DecorationDecConfig()
    {};
    
    _DecorationDecConfig(const std::string _name,
...
#pragma mark- Decoration API
    /* @brief 放大缩小旋转类装饰
       @param config 配置
     */
    void showRotateAndZoomDecoration(DecorationDecConfig config);
     ...
     */
    void showScribblePatternDecoration(DecorationDecConfig config,
                                       Node *scribbleParent,
     ...
     */
    void showReplaceTextureDecoration(DecorationDecConfig config,
     ...
     */
    void showClippingTextureDecoration(DecorationDecConfig config,
                                       Node *clippingParent,
...
protected:
    void setupDecorationWithConfig(DecorationDecConfig config,
...
protected:
    ...
    vector<DecorationDecConfig> _configVec;
    
    Button* _curBtn;
    Sprite* _curBtnBg;
    int _curTag = 0;
    vector<Button*> _typeBtnVec;
    vector<Sprite*> _typeBgVec;

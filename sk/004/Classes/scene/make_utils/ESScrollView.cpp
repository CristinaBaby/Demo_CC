...
void ESScrollView::loadScrollView(int column)
{
    ...
    switch (this->getDirection())
    {
            ...
            if (column == 1)
            {
                ...
                for (int i = 0; i<rowNumber; i++)
                {
                    for (int j = 0; j<column; j++)
                    {
                        ...
                        ui::ImageView* image = _adapter->getUnit(i*column+j);
        ...
        case ui::ScrollView::Direction::HORIZONTAL:
        {
            ...
            for (int i = 0; i<rowNumber; i++)
            {
                    ui::ImageView* image = _adapter->getUnit(_adapter->getStartIndex()+i);
...
void ESScrollView::removeItem(ui::ImageView* image)
{

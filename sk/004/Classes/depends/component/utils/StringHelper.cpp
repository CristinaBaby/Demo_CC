#include "depends/component/utils/StringHelper.h"

void StringHelper::split(const std::string& src, const std::string& token, strArray* strs)
{
    size_t nend = 0;
    size_t nbegin = 0;
...
bool StringHelper::splitWithForm(const std::string& content, strArray* strs)
{
    bool bRet = false;
